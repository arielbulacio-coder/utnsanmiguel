...
const QUESTIONS = [
  ...
  { q:'¿Qué bus apunta la posición de memoria a leer?', opts:['Bus de Datos','Bus de Control','Bus de Direcciones','Bus USB'], a:2, exp:'Bus de Direcciones: unidireccional, indica la ubicación en RAM.' },
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .vn-comp h3 { margin:0; font-size:0.95rem; font-weight:800; }
        ...
        .vn-reg span { flex-shrink:0; }
        .vn-reg code { font-size:0.72rem; word-break:break-all; }
        ...
        .btn-vn-s { cursor:pointer; padding:0.5rem 1rem; border-radius:12px; font-weight:700; font-size:0.82rem; border:none; background:rgba(255,255,255,.08); color:#fff; transition:transform .15s; }
        .btn-vn-s:hover { filter:brightness(1.2); }
        ...
        /* Opciones del quiz: SIEMPRE una por fila */
        ...
        <div className="vn-sim-box">
          <div className="vn-grid">
            ...
            <div className="vn-comp" style={{ borderColor:C.cpu, background:'rgba(0,242,255,0.03)' }}>
              <h3 className="vn-comp-h3" style={{ color:C.cpu }}>🖥 CPU</h3>
            ...
            <div>
              ...
              <div className="vn-options">
                {QUESTIONS[qIdx].opts.map((opt,i)=>{
                  ...
                  let cls = 'vn-opt';
                  if (chosen!==null) { if (isCorrect) cls+=' correct'; else if (picked) cls+=' wrong'; }
                  return (
